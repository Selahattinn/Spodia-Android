...
import static com.example.spodia.AccountGeneral.*;
...
public class UdinicAuthenticator extends AbstractAccountAuthenticator {
    ...
    private String TAG = "SpodiaAuthenticator";
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                Intent request = new Intent(mContext, AuthenticatorActivity.class);
                request.putExtra("name",account.name);
        ...
        final Intent intent = new Intent(mContext, AuthenticatorActivity.class);
        intent.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response.toString());
